from breast_cancer_dataset.datasets import DatasetCBISDDSM
...
if __name__ == '__main__':
    ...
    batch_size, epochs, optimizador = 16, 40, Adam
    ...
    cbis_ddsm = DatasetCBISDDSM()

    # Se realiza la conversión de formato dicom a png.
    # cbis_ddsm.convert_images_format()

    # Se realiza el preprocesado de las fotografías.
    # cbis_ddsm.preproces_full_imges()

    example = r"C:\Users\USUARIO\Desktop\Master Data Science\TFM\Code\data\01_CONVERTED\CBIS_DDSM\BENIGN\FULL\1.3.6.1.4.1.9590.100.1.2.118300872511722827002703686912140380454_1-1.png"
    dest = r"C:\Users\USUARIO\Desktop\Master Data Science\TFM\Code\data\02_PROCESED"
    cbis_ddsm.image_processing([example, dest, 'png', True])
